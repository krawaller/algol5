  ...
  (function() {
    ...
    game.selectunit1 =
      function(turn, step, markpos) {
        ...
        if (ARTIFACTS.mycrowns.hasOwnProperty(MARKS['selectunit'])) {
          ...
          for (var dirnbr = 0; dirnbr < 8; dirnbr++) {
            ...
            if (POS) {
              if (!(ARTIFACTS.myunits.hasOwnProperty(POS))) {
                ARTIFACTS[(ARTIFACTS.oppunits.hasOwnProperty(POS) ? 'killtarget' : 'movetarget')][POS] = {};
              }
            }
          } 
        } else {
          ...
          for (var walkerdirnbr = 0; walkerdirnbr < 6; walkerdirnbr++) {
            ...
            if (STOPREASON === "hitblock") {
              POS = nextpos;
              if ((!(ARTIFACTS.myunits.hasOwnProperty(POS)) && !(([1, 5].indexOf(DIR) !== -1) && ARTIFACTS.oppdaggers.hasOwnProperty(POS)))) {
                ARTIFACTS['movetarget'][POS] = {};
              }
            }
          }
    ...
    game.move1 =
      function(turn, step) {
        ...
        } else turn.links[newstepid].endturn = "maybe";
        return newstep;
      };
    game.start1 =
      function(turn, step) {
