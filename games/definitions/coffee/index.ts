...
import { CoffeeArtifactLayer, CoffeeCommand, CoffeeGenerator, CoffeeLayer, CoffeeMark, CoffeePhase, CoffeeTerrain, CoffeeUnit } from './_types';
...
const coffeeFullDef: FullDef<CoffeeArtifactLayer, CoffeeCommand, CoffeeGenerator, CoffeeLayer, CoffeeMark, CoffeePhase, CoffeeTerrain, CoffeeUnit> = {
  AI: coffeeAI,
  board: coffeeBoard,
  setup: coffeeSetup,
