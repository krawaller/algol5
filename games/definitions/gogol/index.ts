...
import { GogolArtifactLayer, GogolCommand, GogolGenerator, GogolLayer, GogolMark, GogolPhase, GogolTerrain, GogolUnit } from './_types';
...
const gogolFullDef: FullDef<GogolArtifactLayer, GogolCommand, GogolGenerator, GogolLayer, GogolMark, GogolPhase, GogolTerrain, GogolUnit> = {
  AI: gogolAI,
  board: gogolBoard,
  setup: gogolSetup,
