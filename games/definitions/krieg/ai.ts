...
const kriegAI: AI = {
  generators: {
    findmythreats: {
      type: "neighbour",
      starts: "myunits",
      dirs: ["playercase", ["ifelse", ["anyat", "oppbases", ["start"]],
          [4],
          [3, 5]
        ],
        ["ifelse", ["anyat", "oppbases", ["start"]],
          [8],
          [7, 1]
        ]
      ],
      ...
      draw: {
        neighbours: {
          tolayer: ["ifelse", ["anyat", "myfrozens", ["start"]],
    ...
    findoppthreats: {
      type: "neighbour",
      starts: "oppunits",
      dirs: ["playercase", ["ifelse", ["anyat", "mybases", ["start"]],
          [8],
          [7, 1]
        ],
        ["ifelse", ["anyat", "mybases", ["start"]],
          [4],
          [3, 5]
        ]
      ],
      ...
      draw: {
        neighbours: {
          tolayer: ["ifelse", ["anyat", "oppfrozens", ["start"]],
