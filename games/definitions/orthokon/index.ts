...
import { OrthokonArtifactLayer, OrthokonCommand, OrthokonGenerator, OrthokonLayer, OrthokonMark, OrthokonPhase, OrthokonTerrain, OrthokonUnit } from './_types';
...
const orthokonFullDef: FullDef<OrthokonArtifactLayer, OrthokonCommand, OrthokonGenerator, OrthokonLayer, OrthokonMark, OrthokonPhase, OrthokonTerrain, OrthokonUnit> = {
  AI: orthokonAI,
  board: orthokonBoard,
  setup: orthokonSetup,
