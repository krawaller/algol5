...
export type _testUnitLayer = "units" | "myunits" | "oppunits" | "neutralunits" | "stepsfirsts" | "mystepsfirsts" | "oppstepsfirsts" | "neutralstepsfirsts" | "blocksfirsts" | "myblocksfirsts" | "oppblocksfirsts" | "neutralblocksfirsts" | "defaultfirsts" | "mydefaultfirsts" | "oppdefaultfirsts" | "neutraldefaultfirsts" | "noblocks" | "mynoblocks" | "oppnoblocks" | "neutralnoblocks" | "pawns" | "mypawns" | "opppawns" | "neutralpawns";
...
export type _testBoard = Board<_testBoardHeight, _testBoardWidth, _testGrid, _testPosition, _testTerrain>;
export type _testAI = AI<_testAiArtifactLayer, _testAiAspect, _testAiBrain, _testAiGenerator, _testAiGrid, _testAiTerrain, _testAiTerrainLayer, _testBattlePos, _testBattleVar, _testBoardHeight, _testBoardWidth, _testCommand, _testGrid, _testLayer, _testMark, _testPosition, _testTurnPos, _testTurnVar>;
