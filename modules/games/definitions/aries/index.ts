...
import { AriesLayer, AriesMark, AriesCommand, AriesTurnPos, AriesTurnVar, AriesBattlePos, AriesBattleVar, AriesArtifactLayer, AriesGenerator, AriesPhase, AriesTerrain, AriesUnit } from './_types';
...
const ariesFullDef: FullDef<AriesLayer, AriesMark, AriesCommand, AriesTurnPos, AriesTurnVar, AriesBattlePos, AriesBattleVar, AriesArtifactLayer, AriesGenerator, AriesPhase, AriesTerrain, AriesUnit> = {
  AI: ariesAI,
  board: ariesBoard,
  setup: ariesSetup,
