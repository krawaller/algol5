...
export type DaggersBoard = Board<DaggersPosition, DaggersTerrain>;
...
export type DaggersDefinition = FullDef<DaggersAiArtifactLayer, DaggersAiAspect, DaggersAiBrain, DaggersAiGenerator, DaggersAiGrid, DaggersAiTerrain, DaggersAiTerrainLayer, DaggersArtifactLayer, DaggersBattlePos, DaggersBattleVar, DaggersCommand, DaggersGenerator, DaggersGrid, DaggersLayer, DaggersMark, DaggersPhase, DaggersPosition, DaggersTerrain, DaggersTurnPos, DaggersTurnVar, DaggersUnit>;
