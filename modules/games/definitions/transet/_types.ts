...
export type TransetAnim = AlgolAnimCollection<TransetBattlePos, TransetBattleVar, TransetCommand, TransetGrid, TransetLayer, TransetMark, TransetTurnPos, TransetTurnVar, TransetUnit>;
...
export type TransetScripts = AlgolGameTestSuite<TransetCommand, TransetPosition>;
