...
export type CoffeePhaseCommand = "uphill" | "downhill" | "horisontal" | "vertical";
export type CoffeePhase = "startTurn" | CoffeeMark | CoffeePhaseCommand;
...
export type CoffeeFlow = Flow<CoffeeBattlePos, CoffeeBattleVar, CoffeeCommand, CoffeeGenerator, CoffeeLayer, CoffeeMark, CoffeeTurnPos, CoffeeTurnVar>;
...
export type CoffeeDefinition = FullDef<CoffeeArtifactLayer, CoffeeBattlePos, CoffeeBattleVar, CoffeeCommand, CoffeeGenerator, CoffeeLayer, CoffeeMark, CoffeePhase, CoffeeTerrain, CoffeeTurnPos, CoffeeTurnVar, CoffeeUnit>;
