...
export type JostleArtifactLayer = never;
export type JostleTerrainLayer = never;
export type JostleLayer = CommonLayer | JostleUnitLayer;
...
export type JostleFlow = Flow<JostleBattlePos, JostleBattleVar, JostleCommand, JostleLayer, JostleMark, JostleTurnPos, JostleTurnVar>;
