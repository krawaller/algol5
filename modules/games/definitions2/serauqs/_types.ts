...
export type SerauqsPhaseCommand = "promote" | "move";
export type SerauqsPhase = "startTurn" | SerauqsMark | SerauqsPhaseCommand;
...
export type SerauqsFlow = Flow<SerauqsBattlePos, SerauqsBattleVar, SerauqsCommand, SerauqsGenerator, SerauqsLayer, SerauqsMark, SerauqsTurnPos, SerauqsTurnVar>;
...
export type SerauqsDefinition = FullDef<SerauqsArtifactLayer, SerauqsBattlePos, SerauqsBattleVar, SerauqsCommand, SerauqsGenerator, SerauqsLayer, SerauqsMark, SerauqsPhase, SerauqsTerrain, SerauqsTurnPos, SerauqsTurnVar, SerauqsUnit>;
