...
let game: any = {};
const emptyArtifactLayer = { targets: {} };
game.commands = { move: 1, fire: 1 };
game.graphics = { icons: { queens: "queen", fires: "pawn" }, tiles: {} };
...

{
  ...
  game.selectfiretarget1 = function(turn, step, markpos) {
    let MARKS = { selectfiretarget: markpos };
  ...
  game.selectfiretarget1instruction = function(turn, step) {
    ...
    return collapseLine({
      ...
      content: [
        ...
        { type: "text", text: "to destroy the square at" },
        { type: "posref", pos: MARKS["selectfiretarget"] }
      ]
    });
  };
  ...
  game.move1instruction = function(turn, step) {
    return { type: "text", text: "Now select where to fire at" };
  };
  ...
  game.start1instruction = function(turn, step) {
    return collapseLine({
      ...
      content: [
        ...
        { type: "text", text: "to move and fire with" }
      ]
    });
  };
