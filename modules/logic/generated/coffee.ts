...
game.commands = { uphill: 1, downhill: 1, horisontal: 1, vertical: 1 };
game.graphics = { icons: { soldiers: "pawn", markers: "pawn" }, tiles: {} };
game.board = { height: 5, width: 5, terrain: {} };
game.AI = [];
game.id = "coffee";
...

{
        ...
        [
          {
            ...
            content: { type: "cmndref", cmnd: "uphill" }
          },
          {
            cond: Object.keys(ARTIFACTS.downhill).length !== 0,
            content: { type: "cmndref", cmnd: "downhill" }
          },
          {
            cond: Object.keys(ARTIFACTS.vertical).length !== 0,
            content: { type: "cmndref", cmnd: "vertical" }
          },
          {
            cond: Object.keys(ARTIFACTS.horisontal).length !== 0,
            content: { type: "cmndref", cmnd: "horisontal" }
          }
        ]
  ...
  game.start1 = function(lastTurn, step) {
    ...
    for (let linkpos in Object.keys(UNITLAYERS.markers).length === 0
      ? BOARD.board
      : UNITLAYERS.markers) {
  ...
  game.start1instruction = function(turn, step) {
    ...
    return Object.keys(UNITLAYERS.neutralunits).length === 0
      ...
      : { type: "text", text: "Select which neutral unit to take over" };
  };
