...
};
{
  ...
  game.selectdeploy1 = function(turn, step, markpos) {
    let MARKS = Object.assign({}, step.MARKS, {
  ...
  game.selectunit1 = function(turn, step, markpos) {
    ...
    let MARKS = {
      ...
      for (let STARTPOS in walkstarts) {
        let DIR = relativedirs[5 - 2 + (ARTIFACTS.spawndirs[STARTPOS] || {})["dir"]];
        let walkedsquares = [];
        let POS = STARTPOS;
  ...
  game.deploy1 = function(turn, step) {
    ...
    if ((Object.keys(UNITLAYERS.mysoldiers).length > 1)) {
      if ((Object.keys(UNITLAYERS.units).length === 64)) {
        let winner = ((Object.keys(UNITLAYERS.myunits).length > Object.keys(UNITLAYERS.oppunits).length) ? 1 : ((Object.keys(UNITLAYERS.oppunits).length === Object.keys(UNITLAYERS.myunits).length) ? 2 : 0));
...
};
{
  ...
  game.deploy2 = function(turn, step) {
    ...
    if ((Object.keys(UNITLAYERS.mysoldiers).length > 1)) {
      if ((Object.keys(UNITLAYERS.units).length === 64)) {
        let winner = ((Object.keys(UNITLAYERS.myunits).length > Object.keys(UNITLAYERS.oppunits).length) ? 2 : ((Object.keys(UNITLAYERS.oppunits).length === Object.keys(UNITLAYERS.myunits).length) ? 1 : 0));
