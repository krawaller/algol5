...
game.commands = { deploy: 1, move: 1, jump: 1 };
game.graphics = {
...

{
  ...
  game.selectkingdeploy1instruction = function(turn, step) {
    return collapseLine({
      ...
      content: [
        ...
        { type: "text", text: "to place your king here" }
      ]
    });
  };
  ...
  game.selectunit1 = function(turn, step, markpos) {
    ...
    }
    {
      for (let STARTPOS in ARTIFACTS.adjacentenemies) {
        let DIR =
          relativedirs[
            (ARTIFACTS.adjacentenemies[STARTPOS] || {})["dir"] - 2 + 1
          ];
        ...
        if (
          ...
          !(function() {
            let k,
              ret = {},
              s0 = UNITLAYERS.units,
              s1 = !!UNITLAYERS.mykings[MARKS["selectunit"]]
                ? ARTIFACTS.nokings
    ...
    turn.links[newstepid] = {};
    {
      ...
      for (let linkpos in !!UNITLAYERS.mykings[MARKS["selectunit"]]
        ? ARTIFACTS.kingwalk
        : (function() {
            let ret = {},
              s0 = BOARD.board,
  ...
  game.selectunit1instruction = function(turn, step) {
    ...
    return !!UNITLAYERS.kings[MARKS["selectunit"]]
      ? collapseLine({
          type: "line",
          content: [
            { type: "text", text: "Select where to" },
            [
              {
      ...
      : collapseLine({
          type: "line",
          content: [
            { type: "text", text: "Select where to move" },
            Object.keys(ARTIFACTS.jumptargets).length !== 0
              ? { type: "text", text: "or jump" }
              : { type: "nothing" },
            { type: "text", text: "your" },
            {
              type: "unittyperef",
  ...
  game.selectjumptarget1instruction = function(turn, step) {
    ...
    return collapseLine({
      ...
      content: [
        { type: "text", text: "Press" },
        { type: "cmndref", cmnd: "jump" },
        { type: "text", text: "to jump from" },
        { type: "posref", pos: MARKS["selectunit"] },
        { type: "text", text: "to" },
        { type: "posref", pos: MARKS["selectjumptarget"] },
        { type: "text", text: " and kill the" },
        {
          type: "unittyperef",
          name:
            game.graphics.icons[
  ...
  game.start1instruction = function(turn, step) {
    return turn.turn > 2
      ? { type: "text", text: "Select a unit to move" }
      : { type: "text", text: "Select where to deploy your king" };
  };
