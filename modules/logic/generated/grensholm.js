...
import boards from "../../games/definitions/grensholm/boards";
import setups from "../../games/definitions/grensholm/setups";
import variants from "../../games/definitions/grensholm/variants";
const emptyObj = {};
const iconMapping = { soldiers: "knight", kings: "king" };
    ...
    selectunit_basic_1: (step, newMarkPos) => {
      ...
      let UNITLAYERS = step.UNITLAYERS;
      {
        ...
        for (let DIR of UNITLAYERS.mykings[MARKS.selectunit]
          ? ["d1f2r-1", "d5f2r1", "d7f2r1", "d7f2r-1"]
          : ["d1f2r1", "d3f2r1", "d3f2r-1", "d5f2r-1"]) {
          ...
          collapseContent({
            line: [
              Object.keys(UNITLAYERS.mysoldiers).length !== 0
                ? collapseContent({
                    line: [{ unittype: ["knight", 1] }, { text: "to advance" }]
                  })
                : undefined,
        ...
        line: [
          ...
          collapseContent({
            line: [
              Object.keys(UNITLAYERS.mysoldiers).length !== 0
                ? collapseContent({
                    line: [{ unittype: ["knight", 2] }, { text: "to advance" }]
                  })
                : undefined,
              Object.keys(UNITLAYERS.mykings).length !== 0
                ? collapseContent({
