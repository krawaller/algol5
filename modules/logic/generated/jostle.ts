...
game.commands = { jostle: 1 };
game.graphics = { icons: { checkers: "pawn" }, tiles: {} };
game.board = { height: 10, width: 10, terrain: {} };
game.AI = [];
game.id = "jostle";
...

{
  ...
  game.selectunit1instruction = function(turn, step) {
    ...
    return collapseLine({
      type: "line",
      content: [
        { type: "text", text: "This unit neighbours" },
        {
          type: "line",
          content: [
            { type: "text", text: Object.keys(ARTIFACTS.initialfriend).length },
            Object.keys(ARTIFACTS.initialfriend).length === 1
              ? { type: "text", text: "friend" }
              : { type: "text", text: "friends" }
          ]
        },
        { type: "text", text: "and" },
        {
          type: "line",
          content: [
            { type: "text", text: Object.keys(ARTIFACTS.initialenemy).length },
            Object.keys(ARTIFACTS.initialenemy).length === 1
              ? { type: "text", text: "enemy" }
              : { type: "text", text: "enemies" }
          ]
        },
        { type: "text", text: "making the square worth" },
        {
          type: "text",
          text:
        ...
        { type: "text", text: ". Select a higher value square to jostle to" }
      ]
    });
  };
  ...
  game.selectmovetarget1instruction = function(turn, step) {
    ...
    return collapseLine({
      ...
      content: [
        ...
        { type: "text", text: "you would neighbour" },
        {
          type: "line",
          content: [
            { type: "text", text: Object.keys(ARTIFACTS.newfriend).length - 1 },
        ...
        { type: "text", text: "and" },
        {
          type: "line",
          content: [
            { type: "text", text: Object.keys(ARTIFACTS.newenemy).length },
            Object.keys(ARTIFACTS.newenemy).length === 1
              ? { type: "text", text: "enemy" }
              : { type: "text", text: "enemies" }
          ]
        },
        { type: "text", text: ", making it worth" },
        {
          type: "text",
          text:
            Object.keys(ARTIFACTS.newfriend).length -
        ...
        { type: "cmndref", cmnd: "jostle" },
        { type: "text", text: "to move from" },
  ...
  game.start1instruction = function(turn, step) {
    return { type: "text", text: "Select which unit to jostle!" };
  };
