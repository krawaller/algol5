...

{
  ...
  game.selectunit1 = function(turn, step, markpos) {
    ...
    let allwalkerdirs = !!UNITLAYERS.myrunners[MARKS["selectunit"]]
      ? [1, 2, 3]
      : [8, 1, 3, 4];
  ...
  game.selectunit1instruction = function(turn, step) {
    ...
    let UNITLAYERS = step.UNITLAYERS;
    return !!UNITLAYERS.runners[MARKS["selectunit"]]
      ? collapseLine({
          type: "line",
          content: [
      ...
      content: [
        ...
        !!UNITLAYERS.runners[MARKS["selectunit"]]
          ? collapseLine({
              type: "line",
              content: [
                { type: "text", text: "slide your bishop from" },
                { type: "posref", pos: MARKS["selectunit"] },
                { type: "text", text: "to" },
          ...
          : collapseLine({
              type: "line",
              content: [
                { type: "text", text: "move your pawn from" },
                { type: "posref", pos: MARKS["selectunit"] },
                { type: "text", text: "to" },
                { type: "posref", pos: MARKS["selectmovetarget"] },
                !!UNITLAYERS.units[MARKS["selectmovetarget"]]
                  ? { type: "text", text: "and capture the enemy there" }
                  : { type: "nothing" }
              ]
            })
      ]
  ...
  game.start1instruction = function(turn, step) {
    return { type: "text", text: "Select which unit to move" };
  };
