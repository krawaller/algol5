...
let game: any = {};
const emptyArtifactLayer = { movetargets: {}, winline: {} };
game.commands = { promote: 1, move: 1 };
game.graphics = {
...

{
    ...
    return turn.turn > 2
      ...
      : collapseLine({
          ...
          content: [
            ...
            { type: "text", text: ", making it match for your opponent too" }
          ]
        });
  };
  ...
  game.promote1 = function(turn, step) {
    ...
    if (unitid) {
      UNITDATA[unitid] = Object.assign({}, UNITDATA[unitid], { group: "wild" });
    }
