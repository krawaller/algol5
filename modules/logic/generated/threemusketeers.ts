...
game.graphics = { icons: { pawns: "pawn", kings: "king" }, tiles: {} };
  ...
  game.selectunit1instruction = function(turn, step) {
    ...
    return collapseLine({
      ...
      content: [
        ...
        { type: "text", text: "adjacent to the" },
...

{
  ...
  game.selectunit2instruction = function(turn, step) {
    ...
    return collapseLine({
      type: "line",
      content: [
        { type: "text", text: "Select an empty space adjacent to the" },
        { type: "posref", pos: MARKS["selectunit"] },
        {
          type: "unittyperef",
          alias: "pawn",
