...

{
  ...
  game.selectunit1 = function(turn, step, markpos) {
    ...
    let neighbourdirs = !!UNITLAYERS.mykings[MARKS["selectunit"]]
      ? [4, 5, 6]
      : [8, 1, 2];
      ...
      content: [
        ...
        !!UNITLAYERS.oppunits[MARKS["selectmovetarget"]]
          ? collapseLine({
              type: "line",
              content: [
                { type: "text", text: ", killing the enemy" },
                {
                  type: "unittyperef",
                  name:
                    game.graphics.icons[
  ...
  game.move1 = function(turn, step) {
    ...
    if (!!TERRAIN.opphomerow[MARKS["selectmovetarget"]]) {
      {
        ...
        if (unitid) {
          UNITDATA[unitid] = { ...UNITDATA[unitid], group: "kings" };
        }
      }
    }
    {
    ...
    if (
      ...
      turn.endMarks[newstepid].swanhome = (function() {
        let ret = {},
          s0 = UNITLAYERS.mykings,
          s1 = TERRAIN.myhomerow;
        for (let key in s0) {
