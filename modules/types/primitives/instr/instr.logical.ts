...
export interface AlgolInstrIfPlayer<
  Btlp,
  Btlv,
  Cmnd,
  Grid,
...
export interface AlgolInstrIfElse<
  Btlp,
  Btlv,
  Cmnd,
  Grid,
...
export interface AlgolInstrIfActionElse<
  Btlp,
  Btlv,
  Cmnd,
  Grid,
...
export interface AlgolInstrPlayerCase<
  Btlp,
  Btlv,
  Cmnd,
  Grid,
...
export interface AlgolInstrIndexList<
  Btlp,
  Btlv,
  Cmnd,
  Grid,
